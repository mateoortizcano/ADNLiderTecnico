...
public class DocumentoDeIdentidad {
    ...
    public static final String EL_NUMERO_DE_DOCUMENTO_DE_IDENTIDAD_NO_ES_VÁLIDO = "El número de documento de identidad no es válido";
    ...
    public DocumentoDeIdentidad(String tipo, String numero) {
        ...
        validarNumerico(numero, EL_NUMERO_DE_DOCUMENTO_DE_IDENTIDAD_NO_ES_VÁLIDO);
